//  file: diffeq_oscillations_arg.cpp
// 
...
//      02/19/18  use command line arguments rather than console input
//
//  Notes:
...
main (int argc, char *argv[])
{
  ...
  while (answer2 != 0  && current_arg < argc) // iterate until told to move on 
    {
      int answer = 1;           //answer to parameter query
      while (answer != 0 && current_arg < argc)// iterate until told to move on 
	{
	  cout << "\nCurrent parameters:\n";
	  ...
	  switch (answer)
	    ...
	    case 1:
	      //cout << " enter m: ";
	      m = atof(argv[current_arg++]);
	      break;
	    case 2:
	      // cout << " enter k: ";
	      k = atof(argv[current_arg++]);
	      break;
	    case 3:
	      // cout << " enter p: ";
	      p = atof(argv[current_arg++]);
	      break;
	    case 4:
	      // cout << " enter f_ext: ";
	      f_ext = atof(argv[current_arg++]);
	      break;
	    case 5:
	      // cout << " enter w_ext: ";
	      omega_ext = atof(argv[current_arg++]);
	      break;
	    case 6:
	      // cout << " enter phi_ext: ";
	      phi_ext = atof(argv[current_arg++]);
	      break;
	    case 7:
	      // cout << " enter x0: ";
	      x0 = atof(argv[current_arg++]);
	      break;
	    case 8:
	      // cout << " enter v0: ";
	      v0 = atof(argv[current_arg++]);
	      break;
	    case 9:
	      // cout << " enter t_start: ";
	      tmin = atof(argv[current_arg++]);
	      break;
	    case 10:
	      // cout << " enter t_end: ";
	    ...
	    case 11:
	      // cout << " enter h: ";
	      h = atof(argv[current_arg++]);
	      break;
	    case 12:
	      //cout << " enter plot_skip: ";
	      plot_skip = atoi(argv[current_arg++]);
	      break;
	    default:
	      break;
	    }
